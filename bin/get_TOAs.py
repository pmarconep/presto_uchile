...
if __name__ == '__main__':
    ...
    fold_pfd = pfd(sys.argv[-1], inffilepath)
    ...
    if (not fold.topo):
        ...
        try: 
            if t2format:
                ...
                print("Warning! IQUEYE, ARO, IAR and CPT are supported only in TEMPO2 format, this will probably missjudge your telescope")
